...
import { Pill, FileText, Download, Users } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {JSON.parse(localStorage.getItem('patient-medications') || '[]').filter((m: any) => m.active).length}
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {JSON.parse(localStorage.getItem('care-plan-templates') || '[]').length}
          </div>
